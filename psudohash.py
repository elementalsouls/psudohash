...
if (args.custom_paddings_only or args.append_padding) and not (args.common_paddings_before or args.common_paddings_after):
	...
	common_paddings = [
		...
		'!!!', '@@@', '###', '$$$', '%%%', '^^^', '&&&', '***', '(((', ')))', '---', '+++',\
		'11', '12', '13', '22', '1122', '1945', '1995', '1996', '1997', '1998', '1999', '2000',\
		'2001', '2002', '2003', '2004', '2005', '2006', '2008', '2009', '2010', '2011', '2012',\
		'2013', '2014', '2015', '2016', '2017', '2018', '2019', '2020', '2021', '2022', '2023',\
		'2024', '2025', '2026', '2027', '2028', '2029', '2030',\
		'@11', '@12', '@13', '@22', '@1122', '@1945', '@1995', '@1996', '@1997', '@1998', '@1999','@1945', '@1995',\
		...
		'$1996', '$1997', '$1998', '$1999', '$2000','$2001', '$2002', '$2003', '$2004', '$2005', '$2006', '$2008',\
		'$2009', '$2010', '$2011', '$2012','$2013', '$2014', '$2015', '$2016', '$2017', '$2018', '$2019', '$2020',\
		'$2021', '$2022', '$2023','$2024', '$2025', '$2026', '$2027', '$2028', '$2029', '$2030', '$1947', '@1947' 
